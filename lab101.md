...
README](https://github.com/signalfx/o11y-gdi-workshop/blob/master/README.md) for
...
```bash
$ sudo docker run --name docker-${USER} -p 14268:14268 -v /sys/fs/cgroup:/sys/fs/cgroup:ro --privileged -d jrei/systemd-ubuntu
